...
import { venomxJadiBot } from './plugins/jadibot-serbot.js';
...
do {
phoneNumber = await question(chalk.bgBlack(chalk.bold.greenBright(`✦ Por favor, Ingrese el número de WhatsApp.\n${chalk.bold.yellowBright(`✏  Ejemplo: 52667×××××××`)}\n${chalk.bold.magentaBright('---> ')}`)))
...
if (connection == 'open') {
console.log(chalk.bold.green('\n🔥 VenomX-Bot Conectada con éxito 👑'))
}
...
venomxJadiBot({pathvenomxJadiBot: botPath, m: null, conn, args: '', usedPrefix: '/', command: 'serbot'})
}
}
}
}
