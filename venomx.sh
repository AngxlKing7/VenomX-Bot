...
COMANDOS = "pkg install git -y\npkg install nodejs -y\npkg install ffmpeg -y\npkg install imagemagick -y\npkg install -y yarn\ngit clone https://github.com/AngxlKing7/VenomX-Bot\ncd KVenomX-Bot\nyarn install\nnpm install\nnpm start"
...
echo -e "\033[1;35m"
git clone https://github.com/deylinqff/VenomX-Bot-MD.git
...
echo -e "\033[01;32m\033[01mCambiando al directorio del repositorio!!\nChanging to the repository Deylin!!\n\033[0m" 
cd VenomX-Bot
...
» AngxlKing7 
✰ GitHub:
» https://github.com/AngxlKing7

𝐆 𝐑 𝐀 𝐂 𝐈 𝐀 𝐒, 𝐏 𝐎 𝐑, 𝐏 𝐑 𝐄 𝐅 𝐄 𝐑 𝐈 𝐑 𝐍 𝐎 𝐒\n\e[0m"


echo -e "\033[01;32m\033[01mIniciando VenomX-Bot-MD \nVenomX-Bot-MD\n\033[0m"
npm start