...
export async function before(m, { conn, participants, groupMetadata }) {
  ...
  let frasesBienvenida = [
    "¡Bienvenido al equipo de élite de VenomX-Bot! Tu aporte será clave para nuestro crecimiento.",
    "Un nuevo guerrero se une a la batalla. ¡Demos lo mejor para mejorar VenomX-Bot!",
    ...
    "Unir fuerzas nos hace más fuertes. Bienvenido al equipo de VenomX-Bot, juntos somos imparables."
  ];

  let frasesDespedida = [
    "Gracias por tu tiempo y dedicación al equipo. Te deseamos éxito en tus futuros proyectos.",
    "Se cierra un ciclo, pero tu legado en VenomX-Bot queda marcado. ¡Mucho éxito!",
    ...
    "Toda historia tiene un final, pero siempre serás parte del staff de VenomX-Bot. ¡Éxito en todo!"
  ];
  ...
  let imageUrlBienvenida = 'https://files.catbox.moe/ebr65k.jpg'; 
  let imageUrlDespedida = 'https://files.catbox.moe/vgdxmv.jpg';
