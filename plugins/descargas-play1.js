...
const handler = async (m, { conn, text, usedPrefix, command }) => {
  try {
    if (!text.trim()) {
      return conn.reply(m.chat, "⚔️ *Venomx-Bot* | Ingresa el nombre de la canción que deseas buscar.", m, rcanal);
    }
        ...
        try {
          ...
          if (downloadUrl) {
            ...
            await conn.sendMessage(m.chat, {
              ...
              fileName: `${title}.mp4`,
              mimetype: "video/mp4",
              caption: "⚔ Aquí tienes tu video descargado por *Venomx-Bot* ⚔",
              thumbnail: thumb
            }, { quoted: fkontak });
            break;
          }
